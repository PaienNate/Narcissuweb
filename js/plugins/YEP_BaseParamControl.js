 ...
 * ============================================================================
 *
 * 基础参数，例如最大生命值，最大魔法值，攻击，防御，魔攻，魔防，速度，幸
 * 运等，发挥了非常重要的作用。然而缺乏必要的调整来开发他们。这个插件允许
 * 你更好地调节使用
 *
 * 注意：如果你使用了Core Engine，并且改变了参数设置，当你把插件放Core
 * Engine下面时，在这个插件会覆盖原有设定
 *
 * ============================================================================
 ...
 * be (also calculated by the plugin parameters).下面是基础参数计算公式
 *
 ...
 * something along the lines of this by default:参数的上下限也有相应的公式
 *
 *      customMax || (user.isActor() ? 9999 : 999999)
 *      customMin || 1
 *
 * For those wondering about the 'customMax' and 'customMin' values, they are
 * new variables added by this plugin.下面是对公式参数的介绍
 *
 * CUSTOMMAX自定义最大值
 ...
 *   plugin's default formula is utilized.更改参数公式的增加值
 *
 *   <stat Rate: x%>
 *   <stat Rate: x.y>
 *   Replace 'stat' with 'maxhp', 'maxmp', 'atk', 'def', 'mat', 'mdf', 'agi',
 ...
 *   plugin's default formula is utilized.更改参数公式的参数调整率
 *
 *   <stat Flat: +x>
 *   <stat Flat: -x>
 *   Replace 'stat' with 'maxhp', 'maxmp', 'atk', 'def', 'mat', 'mdf', 'agi',
 ...
 *   the plugin's default formula is utilized.更改参数公式的定值
 *
 *   <stat Max: x>
 *   <stat Min: x>
 *   Replace 'stat' with 'maxhp', 'maxmp', 'atk', 'def', 'mat', 'mdf', 'agi',
 ...
 *   value used will be the largest value of 更改参数公式上下限
 *
 * ============================================================================
