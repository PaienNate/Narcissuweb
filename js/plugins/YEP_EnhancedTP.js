 ...
 * ============================================================================
 *
 * TP系统在MV软件里比较受限制，很难控制一场战斗中TP的获得数。这个插件可以
 * 让我们调整不同行动获得TP数，更改TP模式等.
 *
 * ============================================================================
 ...
 *
 *   Help Line 1
 *   Help Line 2    显示在TP模式选择菜单的帮助文本
 *   - This is the help description used for the TP Mode in the TP Mode
 *   selection menu in the Skill Menu (if you have it enabled).
 *
 *   Preserve   每次战斗之后可以储存TP数，如果关闭则每次战斗开始都会清零
 ...
 *   <Unlock TP Mode: x>
 *   <Unlock TP Mode: x, x, x>
 *   <Unlock TP Mode: x to y>    目标解锁TP模式
 ...
 *   <Learn Unlock TP Mode: x to y>    学习技能时解锁TP模式
