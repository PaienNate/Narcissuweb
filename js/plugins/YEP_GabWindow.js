 ...
 * ============================================================================
 *
 * 有时候，通常随机的一些闲聊不需要信息框。闲聊窗口可以写上闲聊语句，并且
 * 放在信息框外面，显示在屏幕角落。闲聊文本将会短暂显示并消失，并且不会在
 * 显示
 *
 * 现在的这个MV版本可以播放声音，可以为闲聊排队增加种类。当闲聊开始，初始
 * 声音会播放至到下一个闲聊语句.
 *
 * ============================================================================
 * Instructions
 * ============================================================================
 *
 * 使用闲聊窗口是很简单的。默认的来说，他可以用在地图或者战斗中。你可以用
 * 插件命令来显示他们.
 *
 * Plugin Commands:
 *
