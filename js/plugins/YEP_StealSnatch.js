 ...
 * ============================================================================
 *
 * 偷窃技能是很多传统RPG都有的技能。这个插件可以让你能够开启这个能力并且更深
 * 度的开发了它
 *
 * 除了默认掉落，敌方有很多东西可以偷窃。当玩家偷窃敌方时，角色会判断成功率
 * 。如果成功则随机得到偷窃池内的物品
 *
 * 除了偷窃，这里还有新的能力叫做抢劫。相比偷窃允许玩家从敌方获得随机物品，
 * 抢劫可以让玩家获得你想偷得物品并且强制得到
 *
 * 插件的另一个特点就是抢劫装备碎片可以减益敌方。如果角色偷了一把攻击10的短
 * 剑，敌方攻击力掉落10。这个功能可以被关闭。敌方不一定会掉落他们的物品，但
 * 是偷窃可以确保你拿到。一旦物品被偷，在战斗结束时将不会掉落
 *
 * ============================================================================
 * Notetags
 * ============================================================================
 ...
 *   <Steal: +x%>
 *   <Steal: -x%>
 *   开启技能或者物品的偷窃特性。拥有偷窃特性的行动有机会偷得物品。适用于所有
 *   物品类型。你还可以设置物品偷窃概率的增减
 *
 *   <Steal Item>
 *   <Steal Item: +x%>
 ...
 *   <Snatch>
 *   <Snatch: +x%>
 *   <Snatch: -x%>  开启抢劫特性，并设定概率，只适用于技能或者物品目标
 ...
 *   <Snatch Item>
 *   <Snatch Item: +x%>
 *   <Snatch Item: -x%> 开启抢劫物品特性，并设定概率，只适用于技能或者物品目标
 *   This enables the skill/item to have snatch properties. Actions with snatch
 *   properties are able to select the exact item they wish to steal. This
 ...
 *   <Snatch Weapon>
 *   <Snatch Weapon: +x%>
 *   <Snatch Weapon: -x%> 开启抢劫武器特性，并设定概率，只适用于技能或者物品目标
 *   This enables the skill/item to have snatch properties. Actions with snatch
 *   properties are able to select the exact item they wish to steal. This
 ...
 *   <Snatch Armor>
 *   <Snatch Armor: +x%>
 *   <Snatch Armor: -x%> 开启抢劫装备特性，并设定概率，只适用于技能或者物品目标
 *   This enables the skill/item to have snatch properties. Actions with snatch
 *   properties are able to select the exact item they wish to steal. This
 ...
 *   <Snatch Gold>
 *   <Snatch Gold: +x%>
 *   <Snatch Gold: -x%> 开启抢劫金钱特性，并设定概率，只适用于技能或者物品目标
 *   This enables the skill/item to have snatch properties. Actions with snatch
 *   properties are able to select the exact item they wish to steal. This
