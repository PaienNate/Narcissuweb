 ...
 *   <Weapon x Cost: y>
 *   <Armor x Cost: y>
 *   设置消耗的物品、武器或者装备，需要数量为y。如果你使用了YEP_ItemCore，
 *   独立物品不可以被消耗。如果你使用了多个标签，技能需要消耗所有的东西
 *
 *   <Item Cost: x Potion>
 *   <Item Cost: x Sword>
 *   <Item Cost: x Feather Cap>
 *   如果你想要使用物品名字取代，你可以使用这个标签。技能需要x数量的物品。
 *   如果你有相同名字物品，优先使用ID最高的。如果你使用了YEP_ItemCore，
 *   独立物品不可以被消耗。如果你使用了多个标签，技能需要消耗所有的东西
 *
 * 技能, 武器, 防具, 状态注释:
 *   <Swap Gauge x: Item y>
 ...
 *   显示队伍拥有物品数量的物品槽。优先按照下面顺序：武器、装备、状态、
 *   职业、敌人
 *
 ...
 *   如果你有重名物品，则优先用ID最高的。优先按照下面顺序：武器、装备、
 *   状态、职业、敌人
 *
 * 主角, 技能, 武器, 防具, 状态注释:
 *   <Item x Cost: +y>
 ...
 *   如果物品不被需要，则这个不会生效。如果你有重名物品，则优先用ID最高的。
 *
 *   <Item x Cost: y%>
 *   <Weapon x Cost: y%>
 *   <Armor x Cost: y%>
 ...
 *   <Item Cost: x% Sword>
 *   <Item Cost: x% Feather Cap>
 *   如果你想使用名字，则用这个标签。改变物品、武器、装备消耗x%。如果物品
 *   不被需要，则这个不会生效。如果你有重名物品，则优先用ID最高的。
 *
 *   <Replace Type x Cost: Type y>
 *   类型可以是物品、武器或则装备。这个让你改变消耗用的类型。替代优先顺序
 *   是状态、武器、装备、职业，然后是角色
 *
 *   <Replace Potion Cost: Ether>
 *   <Replace Sword Cost: Dagger>
 *   <Replace Feather Cap Cost: Bandana>
 *   如果你想使用名字，则用这个标签。这个让你改变消耗用的类型。替代优先顺序
 *   是状态、武器、装备、职业，然后是角色。如果你有重名物品，则优先用ID最高的。
 *
